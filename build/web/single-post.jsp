<%-- 
    Document   : single-post.jsp
    Created on : 26 Aug, 2024, 7:01:54 PM
    Author     : hp
--%>
...
<%
    //if the user is not login and try to access whole single post
  ...
  <%
           ...
           String auname=dao.getUserByUid(uid);
...
<html>
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-body my-3">
                                ...
                                <div class="row" style="text-align:right;">
                                           ...
                                           <p>Posted by- <a href="selectedprofile.jsp?user_id=<%=p.getUserId() %>"><%=auname%></a> </p>
                                ...
                                <div class="footer p-3">
                                     <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-thumbs-o-up"><span>10</span></i></a>
  ...
  <div class="modal fade" id="user-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <script>
           ...
           // document.querySelector("#pcode").innerText.trim();
        </script>
    </body>
</html>
