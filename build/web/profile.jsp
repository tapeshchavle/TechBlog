...
<html>
    ...
    <body>
        ...
        <!--navbar ends here--> 
        <!--when profile gets sucessfully updated-->
       
        <%
            Message msg = (Message) session.getAttribute("msg");
            if (msg != null) {
        %>
        <div class="w-100 mt-5 position-absolute" >
        <div class=" w-100 alert <%=msg.getCssClass()%>" role="alert">
            <%=msg.getContent()%>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-8 offset-md-3">
                        ...
                        <%
                            ...
                            ArrayList<Post> post=postDao.getAllPosts();
                        ...
                        <div class="card " style="width:18rem;">
                            ...
                            <div class="card-body">
                               ...
                               <div id="fix-btn" class="text-center">
                                  ...
                                  %>
                                   <div onclick="doLike(<%= post1.getPid()%>,<%= post1.getUserId()%>)" class="btn btn-outline-primary btn-sm like-btn"><span class="fa fa-thumbs-o-up lubtn"></span><i class="fa fa-thumbs-up ldbtn display-like" ></i><span class="like-counter"><%=ld.countLikeOnPost(post1.getPid())%></span></i></div>
